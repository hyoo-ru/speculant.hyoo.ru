    ...
    class $hyoo_speculant_world extends $.$mol_object2 {
        ...
        intro() {
            return [
                ...
                {
                    text: "Ты можешь покупать и продавать, нажимая на плюс/минус.\nТвоя задача купить девшевле, а продать дороже.\nКупи несколько акций.",
                    wait: 15
                },
                {
                    text: "В вверху отображается твой баланс и кэш.\nБаланс - текущая стоимость всех твоих активов. Баланс изменяется в реальном времени, с учетом текущих цен.\nКэш - аналог наличных денег. Он нужен, чтобы покупать акции.",
                    wait: 15
                },
                {
                    text: "А тут появляются новости. По ним тебе необходимо предсказывать падениеи или подоражание акций, и принимать меры.",
                    wait: 10
                },
                {
                    text: "У тебя есть 1 год(игровой), чтобы установить рекорд по балансу.",
                    wait: 8
                },
                {
                    text: "Удачи!",
