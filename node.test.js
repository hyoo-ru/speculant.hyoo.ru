...
(function ($) {
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_chart_legend.prototype, "Tools", null);
...
(function ($) {
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_chart.prototype, "Legend_tools", null);
    __decorate([
        $.$mol_mem
...
(function ($) {
    class $hyoo_speculant_app_news extends $.$mol_page {
        ...
        News_item(id) {
            ...
            obj.rows = () => [
                this.Date(id),
                this.News_item_title(id),
                this.News_item_body(id)
            ];
            return obj;
        }
        news_list() {
        ...
        News_item_title(id) {
            const obj = new this.$.$mol_text();
            obj.text = () => this.news_item_title(id);
            return obj;
        }
        news_item_body(id) {
            return "";
        ...
        News_item_body(id) {
            const obj = new this.$.$mol_text();
            obj.text = () => this.news_item_body(id);
            return obj;
        }
    }
    __decorate([
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_news.prototype, "Date", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_news.prototype, "News_item_title", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_news.prototype, "News_item_body", null);
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_speculant_app_news extends $.$hyoo_speculant_app_news {
            ...
            news_item_title(news_item) {
                return news_item.title;
            }
            news_item_body(news_item) {
                return news_item.body;
            }
            news_item_date(news_item) {
        ...
        __decorate([
            $.$mol_mem_key
        ], $hyoo_speculant_app_news.prototype, "news_item_date", null);
        $$.$hyoo_speculant_app_news = $hyoo_speculant_app_news;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//news.view.js.map
