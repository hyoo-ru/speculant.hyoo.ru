    ...
    class $hyoo_speculant_world extends $.$mol_object2 {
        ...
        intro() {
            return [
                ...
                {
                    text: "Внизу ты видишь панель управления портфелем.\nТам четыре акции, разных компаний.",
                    wait: 3
                },
                {
                    text: "Мигающие стрелочки - это их текущая стоимость покупки/продажи\nОна изменяется один раз в игровой день(1 секунда)",
                    wait: 5
                },
                {
                    text: "Ты можешь их покупать и продавать, нажимая на плюс/минус.\nТвоя задача купить девшевле, а продать дороже.\nКупи несколько акций.",
                    wait: 12
                },
                {
                    text: "В вверху отображается твой баланс и кэш\nБаланс - текущая стоимость всех твоих акций + кэш. Баланс изменяется в реальном времени с учетом текущих цен акциий.\nКэш - аналог наличных денег. Он нужен чтобы покупать акции.",
                    wait: 15
                },
                {
                    text: "А тут появляются новости. По новостям тебе необходимо предсказывать падениеи или подаражание акций, и принимать меры.",
                    wait: 10
                },
                {
                    text: "У тебя есть 1 год(игровой), чтобы установит рекорд по балансу.",
                    wait: 7
                },
                {
                    text: "Удачи! Не забывай листать ленту новостей вниз!",
                    wait: 1
                }
            ];
        }
    ...
    (function ($$) {
        class $hyoo_speculant_world extends $.$hyoo_speculant_world {
            ...
            time(next) {
                ...
                if (prev.toString() >= this.time_end().toString())
                    return prev;
...
(function ($) {
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_dashboard.prototype, "Icon_currency_up", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_dashboard.prototype, "Icon_currency_down", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_dashboard.prototype, "Balance_currency", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_speculant_app_dashboard.prototype, "Row", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_speculant_app_dashboard.prototype, "Currency_list", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_speculant_app_dashboard.prototype, "News", null);
    __decorate([
        $.$mol_mem
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $.$mol_mem
        ], $hyoo_speculant_app_dashboard.prototype, "currency_work", null);
        __decorate([
            $.$mol_mem_key
...
(function ($) {
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_speculant_app.prototype, "Page_profile", null);
    __decorate([
        $.$mol_mem_key
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_speculant_app extends $.$hyoo_speculant_app {
            ...
            age(next) {
                if (this.persist())
                    return this.$.$mol_state_arg.value('age');
            ...
            currency_all() {
                return this.model().profiles()[this.select_profile()].indicators;
            }
            currency_work() {
                return this.currency_all().filter(key => key !== 'CSH');
            }
        ...
        __decorate([
            $.$mol_mem
        ], $hyoo_speculant_app.prototype, "pages", null);
        __decorate([
            $.$mol_mem
        ], $hyoo_speculant_app.prototype, "final_text", null);
        __decorate([
        ...
        __decorate([
            $.$mol_mem
        ], $hyoo_speculant_app.prototype, "persist_final", null);
        $$.$hyoo_speculant_app = $hyoo_speculant_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//app.view.js.map
    ...
    (function ($$) {
        $_1.$mol_test({
            ...
            'exchange'($) {
                ...
                $_1.$mol_assert_equal(world.indicators().VBL.have, 0);
                $_1.$mol_assert_fail(() => world.exchange('VBL', -2), 'Required at least 2 VBL');
                $_1.$mol_assert_fail(() => world.exchange('VBL', +100500), `Required at least ${world.indicators().VBL.current * 100500} CSH`);
                world.exchange('VBL', +2);
                $_1.$mol_assert_equal(world.indicators().VBL.have, 2);
                $_1.$mol_assert_equal(world.indicators().CSH.have, csh - world.indicators().VBL.current * 2);
                world.exchange('VBL', -2);
                $_1.$mol_assert_equal(world.indicators().VBL.have, 0);
                $_1.$mol_assert_equal(world.indicators().CSH.have, csh);
                world.destructor();
            },
        });
    })($$ = $_1.$$ || ($_1.$$ = {}));
